...
public class MultipartUtility {
	...
	public MultipartUtility(String requestURL) throws IOException {
		...
		requestURL = "https://sandbox.api.sap.com/ml/scenetextrecognition/scene-text-recognition";
	...
	public void addFormField(String name, String value) throws IOException {
		...
		request.writeBytes("Content-Disposition: form-data; files=\"" + name + "\"" + this.crlf);
	...
	public void addFilePart(String fieldName, File uploadFile) throws IOException {
		...
		request.writeBytes(this.twoHyphens + this.boundary + this.crlf);
		request.writeBytes(
				"Content-Disposition: form-data; name=\"" + fieldName + "\";filename=\"" + fileName + "\"" + this.crlf);
		request.writeBytes(this.crlf);
